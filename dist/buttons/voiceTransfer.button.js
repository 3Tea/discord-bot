...
exports.default = {
    id: button_1.BUTTON_ID.VOICE_TRANSFER,
    async execute(interaction) {
        ...
        const selectMenu = new discord_js_1.UserSelectMenuBuilder()
            .setCustomId(button_1.BUTTON_ID.VOICE_SELECT_TRANSFER)
            .setPlaceholder((0, t_1.t)(locale, "voice.select.transfer_placeholder"))
            .setMinValues(1)
            .setMaxValues(1);
