...
exports.default = {
    id: button_1.BUTTON_ID.CONFESSION_APPROVE,
    async execute(interaction) {
        ...
        const result = await (0, confession_service_1.approveConfession)(interaction);
        if (result.ok) {
            await interaction.editReply({ content: (0, t_1.t)(locale, "confession.approve_success") });
            return;
        }
        const codeMap = {
