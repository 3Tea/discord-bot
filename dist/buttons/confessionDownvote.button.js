...
exports.default = {
    id: button_1.BUTTON_ID.CONFESSION_DOWNVOTE,
    async execute(interaction) {
        ...
        const result = await (0, confession_service_1.handleConfessionVote)(mongoId, interaction.guildId, interaction.user.id, "down");
        if (!result.ok) {
