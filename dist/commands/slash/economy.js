...
async function handleConfig(interaction, subcommand, locale, guildId) {
    switch (subcommand) {
        case "reward-view": {
            const config = await guildEconomyRewardConfig_model_1.default.findOneAndUpdate({ guildId }, { $setOnInsert: { guildId } }, { upsert: true, returnDocument: "after" });
        ...
        case "work-view": {
            const wConfig = await guildWorkConfig_model_1.default.findOneAndUpdate({ guildId }, { $setOnInsert: { guildId } }, { upsert: true, returnDocument: "after" });
            return new discord_js_1.EmbedBuilder()
        ...
        case "social-view": {
            const sConfig = await guildSocialConfig_model_1.default.findOneAndUpdate({ guildId }, { $setOnInsert: { guildId } }, { upsert: true, returnDocument: "after" });
            return new discord_js_1.EmbedBuilder()
