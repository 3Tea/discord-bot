...
exports.COMBAT_TIMEOUT_MS = exports.MERCHANT_TTL = exports.COMBAT_TTL = exports.RUN_TTL = void 0;
...
exports.COMBAT_TIMEOUT_MS = 30_000;
...
function buildTrapEmbed(locale, opts) {
    ...
    const descLines = [
        ...
        (0, t_1.t)(locale, "dungeon.trap.damage", { hp: String(hpLost), coin: String(goldLost) }),
...
async function handleTeamTrapEncounter(interaction, locale, party) {
    ...
    const embed = new discord_js_1.EmbedBuilder()
        .setTitle(title)
        .setDescription(`${(0, t_1.t)(locale, "dungeon.encounter.trap", { floor: String(party.floor) })}\n${(0, t_1.t)(locale, "dungeon.trap.damage", { hp: String(trapResult.hpLost), coin: String(trapResult.goldLost) })}`)
        .setColor(0xe67e22);
    await interaction.editReply({ embeds: [embed], components: [] });
    return false;
}
