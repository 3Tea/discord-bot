...
exports.default = {
    ...
    async execute(message) {
        try {
            ...
            const config = await guildXPConfig_model_1.default.findOneAndUpdate({ guildId: message.guild.id }, { $setOnInsert: { guildId: message.guild.id } }, { upsert: true, new: true });
            ...
            if (newLevel > updated.level) {
                ...
                try {
                    ...
                    if (notifConfig.enabled) {
                        ...
                        await (0, notificationService_1.sendNotification)(message.guild, targetChannelId, embed);
                    }
                }
                catch (err) {
