...
const botOutputAudit_service_1 = require("../services/audit/botOutputAudit.service");
const enforce_1 = require("../util/blocklist/enforce");
...
exports.default = {
    ...
    async execute(interaction) {
        if (!interaction.isChatInputCommand())
            return;
        if (await (0, enforce_1.enforceBlocklist)(interaction))
            return;
        ...
        const captured = botOutputAudit_service_1.BotOutputAudit.takeInteractionCapture(interaction.id);
        audit_service_1.AuditService.onCommandExecuted(entry, captured);
    },
};
