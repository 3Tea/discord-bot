    ...
    async execute(member) {
        try {
            ...
            if (welcomeConfig.enabled && welcomeConfig.channelId) {
                ...
                await (0, notificationService_1.sendNotification)(member.guild, welcomeConfig.channelId, embed);
            }
            ...
            if (milestoneConfig.enabled && milestoneConfig.channelId) {
                ...
                if (thresholds.includes(memberCount)) {
                    ...
                    await (0, notificationService_1.sendNotification)(member.guild, milestoneConfig.channelId, embed);
                }
            }
        }
        catch (error) {
