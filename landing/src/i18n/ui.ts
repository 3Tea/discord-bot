...
export const ui = {
  en: {
    ...
    "commands.search.clear": "Clear search",
    "commands.search.hint": "Tip: press / to focus search",
    "commands.search.empty": "No commands matched your filters.",
  ...
  vi: {
    ...
    "commands.search.clear": "Xóa nội dung tìm kiếm",
    "commands.search.hint": "Mẹo: nhấn / để tập trung vào ô tìm kiếm",
    "commands.search.empty": "Không tìm thấy lệnh phù hợp với bộ lọc.",
