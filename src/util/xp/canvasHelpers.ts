...
export function shadow(ctx: Ctx, color: string, blur: number, ox = 0, oy = 0) {
...
function drawAnimeSky(ctx: Ctx): void {
...
function drawNebula(ctx: Ctx): void {
...
function drawStarField(ctx: Ctx): void {
...
function drawCrescentMoon(ctx: Ctx): void {
    const mx = 780,
        my = 52,
        mr = 28;
...
function drawAnimeCloud(ctx: Ctx, cx: number, cy: number, sx: number, sy: number, alpha: number): void {
    ctx.save();
...
function drawMountainLayer(ctx: Ctx, peaks: [number, number][], color: string): void {
    ctx.fillStyle = color;
    ctx.beginPath();
    ctx.moveTo(0, H);
...
function drawMountains(ctx: Ctx): void {
...
function drawTorii(ctx: Ctx): void {
...
function drawSceneBlossoms(ctx: Ctx): void {
...
function drawBokehParticles(ctx: Ctx): void {
...
function drawReadabilityOverlay(ctx: Ctx): void {
...
function drawCircularFallback(ctx: Ctx, cx: number, cy: number, r: number, fallbackChar: string): void {
