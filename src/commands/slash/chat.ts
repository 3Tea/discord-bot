...
import { bold, ChatInputCommandInteraction, EmbedBuilder, italic, SlashCommandBuilder } from "discord.js";
...
export default {
    data: new SlashCommandBuilder()
        ...
        .addStringOption((option) => option.setName("content").setDescription("something...").setRequired(true)),
